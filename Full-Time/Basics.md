...
- **How to fix:** Apply a *non-linear transformation* 
...
- **How to fix:** Minor: adding lags of predictors / ARIMA regressor -- AR(1) adds a lag of X, MA(1) adds a lag of Y
...
- **How to fix:** Model selection 见下方
...
- **How to fix:** (Usually because linearity assumption is violated) consider non-linear transformation.
