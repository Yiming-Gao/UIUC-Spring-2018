...
data_business_restaurants = data_business_restaurants[, c("business_id", "city", "latitude", "longitude", "name", "stars", "state", "review_count")]
```
...
chambana_restaurants = data_business_restaurants %>% 
  ...
  select(business_id, name, stars, latitude, longitude, review_count)
